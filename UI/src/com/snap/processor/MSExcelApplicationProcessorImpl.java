...
import static com.snap.common.util.SnapConstants.MSEXCEL_URLS_FILE_PATH;
...
import static com.snap.common.util.SnapConstants.MSEXCEL_RECOVERY_VBS;

import com.snap.common.util.WriteFileUtility;

public class MSExcelApplicationProcessorImpl implements ApplicationProcessor{
	private static final Logger logger = Logger.getLogger(MSExcelApplicationProcessorImpl.class.getName());
