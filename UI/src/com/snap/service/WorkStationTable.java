...
public class WorkStationTable {
	private static final Logger logger = Logger.getLogger(WorkStationTable.class.getName());
	...
	public WorkStationTable(String Name, String Detail, String DateTime) {
	...
	public WorkStationTable(String Name) {
		logger.debug("Inside InsertIntoTable()");
		this.WorksatationName = new SimpleStringProperty(Name);
		launchButton = new SimpleStringProperty(Name);
		actionButton= new SimpleStringProperty(Name);
